...
public class SalesOrg02AccessRuleForCreate implements AccessRuleForCreate{
	...
	public AccessPermission getPermission(AccessRuleForCreateContext aContext) {
		...
		String jointKey = commodityString +"|"+ businessMaterialTypeString + "|" + procurementPk +"|"+ plantPk +"|"+ "Sales: sales org. 2";
