...
public class MRP01AccessRuleForCreate implements AccessRuleForCreate{
	...
	public AccessPermission getPermission(AccessRuleForCreateContext aContext) {
		...
		String jointKey = commodityString +"|"+ businessMaterialTypeString + "|" + procurementPk +"|"+ plantPk +"|"+ "MRP 1";
