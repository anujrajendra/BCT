...
public class BasicData01AccessRuleForCreate implements AccessRuleForCreate{
	...
	public AccessPermission getPermission(AccessRuleForCreateContext aContext) {
		...
		String jointKey = commodityString +"|"+ businessMaterialTypeString + "|" + procurementPk +"|"+ plantPk +"|"+ "Basic data 1";
