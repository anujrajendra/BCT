...
public class AdditionalDescriptionsAccessRule implements AccessRule{
	...
	public AccessPermission getPermission(final Adaptation adaptation, Session session, SchemaNode node) {
		...
		String jointKey = commodityString +"|"+ businessMaterialTypeString + "|" + procurementPk +"|"+ plantPk +"|"+ "Additional data - Descriptions";
