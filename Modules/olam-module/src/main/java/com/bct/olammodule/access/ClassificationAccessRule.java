...
public class ClassificationAccessRule implements AccessRule{
	...
	public AccessPermission getPermission(final Adaptation adaptation, Session session, SchemaNode node) {
		...
		String jointKey = commodityString +"|"+ businessMaterialTypeString + "|" + procurementPk +"|"+ plantPk +"|"+ "Classification";
