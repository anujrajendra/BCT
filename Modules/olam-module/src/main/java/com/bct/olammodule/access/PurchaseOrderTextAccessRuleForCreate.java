...
public class PurchaseOrderTextAccessRuleForCreate implements AccessRuleForCreate{
	...
	public AccessPermission getPermission(AccessRuleForCreateContext aContext) {
		...
		String jointKey = commodityString +"|"+ businessMaterialTypeString + "|" + procurementPk +"|"+ plantPk +"|"+ "Purchase order text";
