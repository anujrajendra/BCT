...
public class UserRegistrationAllowedShedsPane implements UIFormPane {
	...
	public void writePane(UIFormPaneWriter pWriter, UIFormContext aContext) {
		...
		pWriter.addFormRow(Paths._Root_User_Registration_Details._Root_User_Registration_Details_Allowed_Sheds);
