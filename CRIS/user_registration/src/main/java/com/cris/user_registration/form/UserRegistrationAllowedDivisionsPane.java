...
public class UserRegistrationAllowedDivisionsPane implements UIFormPane {
	...
	public void writePane(UIFormPaneWriter pWriter, UIFormContext aContext) {
		...
		pWriter.add("<table><tr><td>"); // ( "<table><tr><td style='margin-top: 3px; width: 30px; min-width: 30px;
										// max-width: 30px; vertical-align:top'>");

		pWriter.startTableFormRow();

		pWriter.addFormRow(Paths._Root_User_Registration_Details._Root_User_Registration_Details_Allowed_Divisions);
