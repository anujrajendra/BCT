...
public class ShedConstraintEnumeration implements ConstraintEnumeration<String> {
	...
	public List<String> getValues(ValueContext context) throws InvalidSchemaException {
		...
		String userType = (String) context.getValue(
				Path.PARENT.add(Paths._Root_User_Registration_Details._Root_User_Registration_Details_User_Type));
		...
		if (userType != null) {
			if (userType.equalsIgnoreCase("Shed User")) {
