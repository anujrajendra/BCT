	...
	public void checkOccurrence(Object date, ValueContextForValidation context) throws InvalidSchemaException {
		...
		if (date != null) {
			...
			if (commissioningDate != null) {
				if (!commissioningDate.equals((Date) date)) {
...
//						if (attributeName.equalsIgnoreCase("Loco Receiving Date"))
//							context.addError("Date of Receiving should be less than Date of Commissioning");
					}
				}
			}
		}
