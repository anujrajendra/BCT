...
//							continue;
			...
			String userPermissionsZoneQuery = "Select s.\"$adaptation\" from \"/root/User_Permissions_Zone\" s where FK_AS_STRING('user_data','/root/User_Permissions_Zone', s.Ipas_Id) = '"
					+ userId + "'";
			...
			String userPermissionsDivisionQuery = "Select s.\"$adaptation\" from \"/root/User_Permissions_Division\" s where FK_AS_STRING('user_data','/root/User_Permissions_Division', s.Ipas_Id) = '"
					+ userId + "'";
			...
			String userPermissionsShedQuery = "Select s.\"$adaptation\" from \"/root/User_Permissions_Shed\" s where FK_AS_STRING('user_data','/root/User_Permissions_Shed', s.Ipas_Id) = '"
					+ userId + "'";
			...
			if (userPermissionsShedRecords.iterator().hasNext()) {
			...
			} else if (userPermissionsZoneRecords.iterator().hasNext()) {
