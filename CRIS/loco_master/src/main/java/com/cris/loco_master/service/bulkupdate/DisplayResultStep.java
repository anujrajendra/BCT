...
public class DisplayResultStep implements DisplayStep {
	...
	DisplayConfirmationScreen displayMessage;

	public DisplayResultStep() {
		this.displayMessage = new DisplayConfirmationScreen();
	}
	...
	protected void writeContent(final UserServicePaneContext context, final UserServicePaneWriter writer) {
		...
		final UserMessage message = UserMessage
				.createInfo("The bulk update for the selected records has been completed successfully.");
