...
public final class RepositoryUtils {
	...
	public static Adaptation getLinkedRecords(Path foreignKeyNodePath, ValueContext vc) {

		AdaptationTable table = vc.getAdaptationTable();
		SchemaNode fkNode = table.getTableNode().getNode(foreignKeyNodePath);
		SchemaFacetTableRef tableRef = fkNode.getFacetOnTableReference();
		Adaptation linkedRecord = tableRef.getLinkedRecord(vc);
		return linkedRecord;
	}
