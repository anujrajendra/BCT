package com.cris.reference_master.constraints;
...
public class DivisionErrorForShedTable implements Constraint<String> {
	...
	public void checkOccurrence(String arg0, ValueContextForValidation context) throws InvalidSchemaException {
		...
		String divisionValue = (String) context
				.getValue(Path.PARENT.add(Paths._Root_Shed._Root_Shed_Division_Code));
