...
public interface Paths
{
	...
	// Table type path
	public final class _Root_ReferenceDoc
	{
		private static final Path _Root_ReferenceDoc = _Root.add("reference-doc");
		public static Path getPathInSchema()
		{
			return _Root_ReferenceDoc;
		}
		public static final Path _Root_ReferenceDoc_SNo = Path.parse("./s-no");
		public static final Path _Root_ReferenceDoc_Entity = Path.parse("./entity");
		public static final Path _Root_ReferenceDoc_SubEntity = Path.parse("./sub-entity");
		public static final Path _Root_ReferenceDoc_DOCName = Path.parse("./DOC-name");
		public static final Path _Root_ReferenceDoc_Doc = Path.parse("./doc");
		public static final Path _Root_ReferenceDoc_Doc_Attachment = Path.parse("./doc/attachment");
		public static final Path _Root_ReferenceDoc_DocDescription = Path.parse("./doc-description");
	} 
	...
	// Table type path
	public final class _Root_Email_Templates
	{
		private static final Path _Root_Email_Templates = _Root.add("Email_Templates");
		public static Path getPathInSchema()
		{
			return _Root_Email_Templates;
		}
		public static final Path _Root_Email_Templates_Id = Path.parse("./Id");
		public static final Path _Root_Email_Templates_Purpose = Path.parse("./Purpose");
		public static final Path _Root_Email_Templates_Email_Subject = Path.parse("./Email_Subject");
		public static final Path _Root_Email_Templates_Email_Templates = Path.parse("./Email_Templates");
		public static final Path _Root_Email_Templates_Email_Variable = Path.parse("./Email_Variable");
	} 

	// Table type path
	public final class _Root_Email_Variables
	{
		private static final Path _Root_Email_Variables = _Root.add("Email_Variables");
		public static Path getPathInSchema()
		{
			return _Root_Email_Variables;
		}
		public static final Path _Root_Email_Variables_Id = Path.parse("./Id");
		public static final Path _Root_Email_Variables_Email_Template = Path.parse("./Email_Template");
		public static final Path _Root_Email_Variables_Value = Path.parse("./Value");
		public static final Path _Root_Email_Variables_User = Path.parse("./user");
	} 
	// ===============================================
