...
public class LaunchUpdateWorkflowService implements UserService<TableViewEntitySelection>{
	...
	public UserServiceEventOutcome processEventOutcome(
		...
		launcher = wfEngine.getProcessLauncher(PublishedProcessKey.forName("Coach_Update"));
		...
		launcher.setLabel(UserMessage.createInfo("Coach Record Modification"));
		launcher.setDescription(UserMessage.createInfo("Coach Record Modification"));
